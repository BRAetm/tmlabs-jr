"""
engine_core.py — Headless NBA 2K shot-timing engine.

Usage:
  python engine_core.py [--labs-pid N] [--session N]
                        [--threshold 0.95] [--threshold-l2 0.75]
                        [--tempo] [--tempo-ms 39]
                        [--stick-tempo] [--quickstop]
                        [--defense] [--stamina] [--no-hands-up]
                        [--xi-index 0] [--gpu 0]

Pipeline:
  • find_window()        — finds LabsEngine's Remote Play window
  • BetterCam (240fps)   — captures that window as BGR frames
  ...
  • LabsEngine's XInput  — reads our virtual pad (slot 1+ with skip mask)
    plugin                 and forwards to the PS5 stream.
