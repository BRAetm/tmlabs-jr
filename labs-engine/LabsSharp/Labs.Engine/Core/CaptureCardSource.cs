...
/// <param name="Width">Device-reported native frame width (0 if unknown).</param>
/// <param name="Height">Device-reported native frame height (0 if unknown).</param>
public record CaptureDeviceInfo(int Index, string Name, int Width = 0, int Height = 0);
    ...
    public static List<CaptureDeviceInfo> ScanDevices(int maxDevices = 10)
    {
        ...
        for (int i = 0; i < scanLimit; i++)
        {
            ...
            try
            {
                ...
                devices.Add(new CaptureDeviceInfo(i, name, w, h));
