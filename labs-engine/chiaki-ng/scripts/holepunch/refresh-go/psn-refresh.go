...
func main(){
    ...
    file, err := os.OpenFile("/home/streetpea/Documents/psn-labs/token.txt", os.O_WRONLY|os.O_CREATE, 0666)
    if err != nil {
	...
	fmt.Println("Your credentials are saved to: /home/streetpea/Documents/psn-labs/token.txt")
